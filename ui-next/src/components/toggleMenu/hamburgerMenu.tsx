        ...
        <div className={styles.hamburgerDropdown}>
            ...
            <div className={styles.hamburgerMenuItems}>
                {!isLoading && !currentUser && (
                    <div>
                        <button
                            onClick={() => handleMove("/auth/signin")}
                ...
                <button onClick={() => handleMove("/")} className={styles.hamburgerMenuItem}>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" style={{ marginRight: 4 }}>
                            <path
                                d="M3 12L12 3L21 12"
                ...
                <button onClick={() => handleMove("/posts?category=featured")} className={styles.hamburgerMenuItem}>
                    <span style={{ display: "inline-flex", alignItems: "center", gap: 6 }}>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" style={{ marginRight: 4 }}>
